...
var link8 = new joint.dia.Link({
    ...
    labels: [
        ...
        { position: .45, attrs: { text: { text: 'multiple', fill: 'white', 'font-family': 'sans-serif' }, rect: { stroke: '#3498DB', 'stroke-width': 20, rx: 5, ry: 5 } }},
        { position: .55, attrs: { text: { text: 'labels', fill: 'white', 'font-family': 'sans-serif' }, rect: { stroke: '#3498DB', 'stroke-width': 20, rx: 5, ry: 5 } }},
