(function () {
    ...
    var paper = new joint.dia.Paper({ el: $('#paper-holder-fixed-axis'), width: 800, height: 200, model: graph, gridSize: 1 });
    ...
    var chart = new joint.shapes.chart.Plot({
        ...
        axis: {
            'x-axis': { tickFormat: '0d', min: -3, max: 10 },
            'y-axis': { min: -5, max: 10, ticks: 3 }
        },
        attrs: {
            '.data .myserie path': {
