(function () {
    ...
    var paper = new joint.dia.Paper({ el: $('#paper-holder-exploding'), width: 700, height: 400, model: graph, gridSize: 1 });
...
function fill() {
    // We use the great randomColor library to automatically generate pretty colors.
